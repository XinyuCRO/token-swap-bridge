...
async function main() {
  ...
  program
    ...
    .action(async (cmd) => {
      ...
      cmd.erc20Bridge = deployer.addresses.Bridges.ERC20BridgeProxy;
     ...
     const gasPrice = cmd.gasPrice ? parseUnits(cmd.gasPrice, 'gwei') : await provider.getGasPrice();
      ...
      const l1GovernorAddress = deployWallet.address;
      ...
      console.log("l2TokenFactoryAddr: ", l2TokenFactoryAddr);
      console.log("l2GovernorAddress: ", l2GovernorAddress);
      ...
      const independentInitialization = [
        zkSync.requestL2Transaction(
          ...
          { maxFeePerGas, nonce, maxPriorityFeePerGas, gasLimit: 2000000}
        ),
